pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__arrman.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__arrman.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_arrman");
...
--  BEGIN Object file/option list
   --   E:\Univer\paralel\obj\arrman.o
   --   -LE:\Univer\paralel\obj\
   --   -LE:\Univer\paralel\obj\
   --   -LE:/programs/gnat_ada/lib/gcc/x86_64-w64-mingw32/10.3.1/adalib/
   --   -static
   --   -lgnarl
   --   -lgnat
   --   -Xlinker
